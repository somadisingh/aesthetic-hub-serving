...
# assumes that the df has the columns IMAGEPATH  & AVERAGE_RATING
...
for idx, row in df.iterrows():
    ...
    # all CLIP embeddings are getting normalized. This also has to be done when inputting an embedding later for inference
